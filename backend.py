...
class ToolLayer:
    ...
    def run_shell(self, command: str) -> dict:
        """
        Execute a workspace command without shell interpretation.
        
        Parameters:
            command (str): Command text to parse and execute.
        
        Returns:
            dict: Execution status, output or error details, and return code when the command runs.
        """
        import shlex
